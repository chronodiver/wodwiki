...
foreach ($result as $tab => $entries) {
    foreach ($entries as $entry) {
        $allSteamIds = array_merge($allSteamIds, $entry['players']);
    }
}

$steamUrl = "https://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=$apiKey&steamids=" . implode(',', $allSteamIds);
